package com.example.memberservicenacosprovider10006.service.impl;
...
import com.example.memberservicenacosprovider10006.domain.vo.MemberVo;
import com.example.memberservicenacosprovider10006.mapper.MemberMapper;
...
public class MemberServiceImpl implements MemberService {
    ...
    public ResponseResult<Object> memberQuery() {
        try {
            ...
            return ResponseResult.ok("member-service-provider-10006", memberVos);
        } catch (Exception e) {
