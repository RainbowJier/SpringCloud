package com.example.memberservicenacosprovider10004.service.impl;

import cn.hutool.core.bean.BeanUtil;
import com.baomidou.mybatisplus.core.conditions.query.LambdaQueryWrapper;
import com.baomidou.mybatisplus.core.conditions.query.QueryWrapper;
import com.example.memberservicenacosprovider10004.domain.ResponseResult;
import com.example.memberservicenacosprovider10004.domain.entity.Member;
import com.example.memberservicenacosprovider10004.domain.vo.MemberVo;
import com.example.memberservicenacosprovider10004.mapper.MemberMapper;
import com.example.memberservicenacosprovider10004.service.MemberService;
...
public class MemberServiceImpl implements MemberService {
    ...
    public ResponseResult<Object> memberQuery() {
        try {
            ...
            return ResponseResult.ok("member-service-provider-10004", memberVos);
        } catch (Exception e) {
    ...
    public ResponseResult<Object> saveMember(Member member) {
        try {
    ...
    @Override
    public ResponseResult<Object> getMemberById(Long id) {
        try {
